...
# Returns TRUE if a color is a valid color defined in CoreUI, throws error
# otherwise.
validateColor <- function(color) {
        if (color %in% validColors) return(TRUE)
...
validateStatus <- function(status) {
        if (status %in% validStatuses) return(TRUE)
...
#'
#' @keywords internal
validStatuses <- c("primary", "secondary", "success", "info", "warning", "danger")
