...
#' Assert a tag has specified properties.
#'
#' @param tag A tag object.
#' @param type The type of a tag, like "div", "a", "span".
#' @param class An HTML class.
#' @param allowUI If TRUE (default), allow dynamic output generated by
#'   \code{\link[shiny]{uiOutput}} or \code{\link[shiny]{htmlOutput}}. When
#'   dynamic output is provided, \code{tagAssert} won't try to validate the
#'   contents.
#' @keywords internal
